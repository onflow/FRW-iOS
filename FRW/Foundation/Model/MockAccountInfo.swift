...
extension AccountModel {
    ...
    static func mockSamples() -> AccountModel {
        ...
        let coa = AccountModel(account: accounts[1], mainAccount: accounts[0], flowCount: "0.00", nftCount: 0, linkedAccounts: [])
        let link = AccountModel(account: accounts[2], mainAccount: accounts[0], flowCount: "999.99", nftCount: 99, linkedAccounts: [])
        let main = AccountModel(account: accounts[0], mainAccount: nil, flowCount: "123.45", nftCount: 7, linkedAccounts: [coa, link])
